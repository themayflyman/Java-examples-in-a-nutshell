...
public class Rect {
     ...
     * same name as the class, and that it has no return value declared in
     * its signature.
     */
     ...
     * smallest recetangle that includes them both.
     */
     ...
     * concatenated so strings with the + operator, and can be passed to
