...
public class Sorter {
     ...
     * To sort object of a given type, you must provide a Comparer
    ...
    public static void sortAsciiIgnoreCase(String[] a, int from, int to,
        ...
        // Sort that secondary array, and rerrange the original array
    ...
    public static void sort(String[] a, int from, int to,
                            boolean up, boolean igonorecase) {
        sort(a, from, to, up, igonorecase, null);
    }
    ...
    public static void sort(String[] a, int from, int to,
        ...
        if(ignreocase) c.setStrength(Collator.SECONDARY);
                            ...
                            boolean up, Comparer c)
    {
        ...
        // should understand what the codes does, but don't have to understand
    ...
    public static class Test {
        ...
        /* A test program that sorts complex numbers in various ways. */
        public static void main(String[] args) {
            // Define an array of SortableComplextNumber objects. Initialize it
            ...
            // Now sort it using SortableComplexNumber compareTo() method,
            // which sorts by magnitude, and print the results out.
            System.out.println("Sorted by magnitude:");
            Sorter.sort(a);
            // for(int i=0; i<a.length; i++) System.out.println(a[i]);
            for(ComplexNumber aa: a) System.out.println(aa);
