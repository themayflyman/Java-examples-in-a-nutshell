...
public class GenericClient {
    public static void main(String[] args) throws IOException {
        try {
            ...
            // it to the user. We use a separate thread for thsi so that we
            ...
            Thread t = new Thread() {
                public void run() {
                    ...
                    // When the server cloese the connection, the loop above
            ...
            // their input, we'l get an EOF, and the loop above will exit.
