    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if ((args.length != 1) && (args.length != 2))
                throw new IllegalArgumentException("wWrong number of args");
            ...
            // Now copy byets from the URL to the output stream
        ...
        finally { // Alwyas close the streams, no matter what.
            try {
                in.close();
                out.close();
            } catch (Exception e) {
