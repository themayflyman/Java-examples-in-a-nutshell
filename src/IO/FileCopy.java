...
/**
 * This class ia standalone program to copy a file, and also defines a
...
public class FileCopy {
        ...
        throws IOException
    {
        ...
        if(to_file.exists()) {
            ...
            System.out.println("Overwrite existing file " + to_file.getName() +
                               "? (Y/N): ");
            System.out.flush();
        ...
        try {
            ...
            // -1). Note the combination of assignment and comparsion in this
