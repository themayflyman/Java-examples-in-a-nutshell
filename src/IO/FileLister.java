 ...
 * files and sub-directories ina specified directory. Clicking on an
...
public class FileLister extends Frame implements ActionListener, ItemListener {
    ...
    public void listDirectory(String directory) {
        ...
        // ObjectsClassesAndInterfaces.Sorter.sort() to sort instead.
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        // And dispaly the details string
     ...
     * directory, call listDirectory() method to display that directory
     */
    ...
    public static void usage() {
        System.out.println("Usage: jave FileLister [directory_name] " +
                           "[-e file_extension]");
        System.exit(0);
    }
