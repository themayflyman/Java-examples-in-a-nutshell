...
public class RemoveHTMLReader extends FilterReader {
    ...
    /**
     * This is the implementation of the no-ip read() method of FilterReader.
     * It calls in.read() to get a buffer full of characters, then strips
     * out the HTML tags. (in is protected field of the superclass).
     */
    public int read(char[] buf, int from, int len) throws IOException {
        ...
        while(numchars == 0) {
            ...
            // Loop through the character we read, stripping out HTML tags.
