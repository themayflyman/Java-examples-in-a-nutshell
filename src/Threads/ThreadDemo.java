...
/**
 * This class demonstrates the use of the threads. The main() method is the
 * initial method invoked by the interpreter. It defines and starts two
 * more threads and teh three threads run at the same time. Note that this
...
public class ThreadDemo extends Thread {
    ...
    public static void main(String[] args) {
        ...
        // Create the second thread by pass a Runnable object to the
        ...
        // Jave interpreter. Now that thread does more stuff, too.
        for(int i=0; i<5; i++) compute();

        // We would wait for the threads to stop running with these lines
        // But they aren't necessnary here, so we don't bother.
        // try {
        //     thread1.join();
        //     thread2.join();
        // } catch (InterruptedException e) {}

        // The Java VM exists only when the main() method returns, and when all
        // threads stop running (excepet for daemon threads--see setDaemon()).
    }

    // ThreadLocal objects represent a value accessed with get() and set().
    ...
    /** This is the dummy method our thread all call */
